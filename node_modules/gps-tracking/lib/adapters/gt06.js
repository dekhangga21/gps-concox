...
var adapter = function (device) {
  ...
  this.parse_data = function (data) {
    console.log('datagps', data)
    data = data.toString('hex');
    console.log('datagps2', data)
    var parts = {
  ...
  this.authorize = function () {
    ...
    var crc = require('/home/ubuntu/gps-concox/node_modules/crc/lib/index.js');
  ...
  this.get_mileages = function (dex) {
    return parseInt(dex, 16) / 1000;
  };
  ...
  this.get_ping_data = function (msg_parts) {
    ...
    var data = {
      'date': parseInt(str.substr(0, 12), 16),
      'set_count': str.substr(12, 2),
      'latitude_raw': str.substr(14, 8),
      'longitude_raw': str.substr(22, 8),
      'latitude': this.dex_to_degrees(str.substr(14, 8)),
      ...
      'cell_id': parseInt(str.substr(46, 6), 16),
      'acc': str.substr(52, 2),
      'upload_mode': str.substr(54, 2),
      'realtime_reupload': str.substr(56, 2),
      'mileage': this.get_mileages(str.substr(58, 8)),
    };
